      ...
      {({ open }) => (
        <>
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            <div className='flex h-16 items-center justify-between'>
                      ...
                      <Link
                        ...
                        className={classNames(
                          item.current
                            ...
                            : 'text-white hover:bg-background hover:text-black',
              ...
              <div className='-mr-2 flex md:hidden'>
                {/* Mobile menu button */}
                <Disclosure.Button className='relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-secondary hover:bg-background hover:text-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800'>
          ...
          <Disclosure.Panel className='md:hidden'>
            ...
            <div className='border-t border-secondary pb-3 pt-4'>
              <div className='flex items-center px-5'>
                ...
                <div className='ml-3'>
                  ...
                  <div className='text-sm font-medium leading-none text-background'>
                    {user.email}
                  </div>
                </div>
                <button
